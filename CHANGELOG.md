...
- Completed an offline vector study for all 173 catalog entries, including the 70 future/oddity entries still marked `reserved`. The generated media remains local; only the packer and public status documentation are versioned.
